...
export default class extends BaseClient {
	 ...
	 * @returns {Promise}
	 */
	communitySignup(username, email, callback = r => r) {
	 ...
	 * @returns {Promise}
	 */
	communityTransfer(username, email, secondaryEmail, callback = r => r) {
	 ...
	 * @returns {Promise}
	 */
	generateCoupon(platform, coins, gems, callback = r => r) {
	 ...
	 * @returns {Promise}
	 */
	redeemCoupon(code, callback = r => r) {
